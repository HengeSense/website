...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field site on 'News'
        db.create_table('news_news_site', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('news', models.ForeignKey(orm['news.news'], null=False)),
            ('site', models.ForeignKey(orm['sites.site'], null=False))
        ))
        db.create_unique('news_news_site', ['news_id', 'site_id'])
    ...
    def backwards(self, orm):
        ...
        # Removing M2M table for field site on 'News'
        db.delete_table('news_news_site')
